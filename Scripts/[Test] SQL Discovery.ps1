...
$VisualStudio_Setup_Metadata = @{
  # 2017
  "2017 Enterpise"    = @{ Url = "https://aka.ms/vs/15/release/vs_enterprise.exe";   TestOrder = 14 }
  ...
  # 2019
  "2019 Enterpise"    = @{ Url = "https://aka.ms/vs/16/release/vs_enterprise.exe";   TestOrder = 13 }
  ...
  # 2022
  "2022 Enterpise"    = @{ Url = "https://aka.ms/vs/17/release/vs_enterprise.exe";   TestOrder = 12 }
  ...
  # 2026
  "2026 Enterpise"    = @{ Url = "https://aka.ms/vs/stable/vs_enterprise.exe";   TestOrder = 11 }
...
$servers = @(Find-Local-SqlServers | % { Set-Property-Smarty $_ "MediumVersion" (Query-SqlServer-Version -Title "$($_.Instance) v$($_.InstallerVersion)" -Instance "$($_.Instance)" -Timeout 60); $_ })
