...
$SqlServer2010DownloadLinks = @(
  ...
  @{ 
    ...
    Developer="https://sourceforge.net/projects/archived-sql-servers/files/sql_server_2008_rtm_developer_edition_x64.7z/download" # RTM
    DeveloperFormat="Archive"
    CU=@(
  ...
  @{ 
    ...
    Developer="https://sourceforge.net/projects/archived-sql-servers/files/sql_server_2008_rtm_developer_edition_x86.7z/download" # RTM
    DeveloperFormat="Archive"
    CU=@(
