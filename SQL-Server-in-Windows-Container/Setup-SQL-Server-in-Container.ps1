...
{ 
    ...
    $v2014_rules = "ThreadHasAdminPrivilegeCheck HasSecurityBackupAndDebugPrivilegesCheck RebootRequiredCheck WmiServiceStateCheck AclPermissionsFacet MediaPathLength SetupCompatibilityCheck NoRebootPackage NoRebootPackageDownLevel ServerCorePlatformCheck ServerCore64BitCheck FacetWOW64PlatformCheck FusionRebootCheck Bids2008InstalledCheck AclPermissionsFacet FacetDomainControllerCheck SSMS_IsInternetConnected IsFirewallEnabled ServerCoreBlockUnsupportedSxSCheck SQL14CTP1SideBySideInstallCheck DEV10RTMDetected ASSPIInstanceNameNotInUseCheck ASIsValidEditionForDeploymentModeCheck SlipstreamMediaInfoCheck PowerShellCheck InternetConnectionToNETFX4DownloadSite ServerCoreBlockUnsupportedFeaturesCheck ServerCoreNetFxCheck RS_IsDotNet3_5Installed VS2012CompatibilityRule AS_IsDotNet4_5Installed"
